...
- Sunucuda beş dakikalık cron, yayın dalını fetch/checkout/fast-forward eder; başarısız Git işlemi dağıtımı durdurur. İşlem kilidi eşzamanlı çalışmaları engeller.
