...
defineProps<{ row: Record<string, any>; priceEntry?: boolean; fields: { key: string; label: string; type?: string; readonly?: boolean; options?: string[] }[] }>();
