...
<section class="stop-sales" aria-label="Satış Durdurma">
 ...
 <form v-if="draft" @submit.prevent="save">
  <label>Başlangıç Tarihi<DateInput :range-end="draft.lastDate" v-model="draft.firstDate" required /></label><label>Bitiş Tarihi<DateInput :range-start="draft.firstDate" v-model="draft.lastDate" :min="draft.firstDate" required /></label><label>Kayıt Tarihi<DateInput v-model="draft.recordDate" readonly required /></label>
