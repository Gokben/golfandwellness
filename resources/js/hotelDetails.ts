...
export type HotelContract = {
    ...
    prices: { id: string; accommodationId: string; accommodation: string; ageTable: string; pax: string; infants: string; children: string; parity: string; price: string; currency: string }[];
