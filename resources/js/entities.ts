...
export type AgencyHotelContract = { id: string; name: string; hotelName: string; currency: string; sourceSeasonId: string; markupMode: 'percent' | 'fixed'; markupAmount: number; contracts: import('./hotelDetails').HotelContract[] };
export type Agency = { name: string; code: string; citizen: string; market: string; address: string; extrasKey?: string; subMarket?: string; additionalInfo?: string; contactName?: string; contactEmail?: string; contactPhone?: string; webAddress?: string; hotelContracts?: AgencyHotelContract[] };
